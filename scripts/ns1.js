...
module.exports = function NS1Script (robot) {
  ...
  robot.respond(/ns1 create zone (.*)/i, (res) => {
    ...
    function success () {
      return RespondToUser(robot, res, null, 'Zone created successfully.', 'success')
    }
  ...
  robot.respond(/ns1 delete zone (.*)/i, (res) => {
    ...
    function success () {
      return RespondToUser(robot, res, null, 'Zone deleted successfully.', 'success')
    }
  ...
  robot.respond(/ns1 create record (.*) (.*) (.*) (.*)/i, (res) => {
    ...
    const NS1Promise = Promise.resolve()
      ...
      .tap(success)
      .then(respond)
      .catch(ErrorHandler(robot, res, 'ns1 create record <zone> <domain> <type> <field>'))
    ...
    function createRecord () {
      const Answers = R.map(answer => ({ answer: R.split(',', answer) }), R.split('|', Field))
    ...
    function success () {
      return RespondToUser(robot, res, null, 'DNS record created successfully.', 'success')
    }
  ...
  robot.respond(/ns1 update record (.*) (.*) (.*) (.*)/i, (res) => {
    ...
    const NS1Promise = Promise.resolve()
      ...
      .tap(success)
      .then(respond)
      .catch(ErrorHandler(robot, res, 'ns1 update record <zone> <domain> <type> <field>'))
    ...
    function success () {
      return RespondToUser(robot, res, null, 'DNS record updated successfully.', 'success')
    }
  ...
  robot.respond(/ns1 delete record (.*) (.*) (.*)/i, (res) => {
    ...
    const NS1Promise = Promise.resolve()
      ...
      .then(deleteRecord)
      .tap(success)
      .catch(ErrorHandler(robot, res, 'ns1 delete record <zone> <domain> <type>'))
    ...
    function success () {
      return RespondToUser(robot, res, null, 'DNS record deleted successfully.', 'success')
    }
